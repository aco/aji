...
@objc public class BLTNItemAppearance: NSObject {
    ...
    @objc public var actionButtonColor = Style.Colors.primaryGreen
	...
	@objc public var alternativeButtonTitleColor = Style.Colors.link
    ...
    @objc public var titleFontSize: CGFloat = 22

    /// The font size of description labels (default 20).
    @objc public var descriptionFontSize: CGFloat = 15

    /// The font size of compact description labels (default 15).
    @objc public var compactDescriptionFontSize: CGFloat = 12
